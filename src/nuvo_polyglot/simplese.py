...
class SimpleseController(polyinterface.Controller):
    """
    ...
    def __init__(self, polyglot):
        ...
        """
        super(SimpleseController, self).__init__(polyglot)
        self.name = 'Nuvo Simplese Controller'
    ...
    def start(self):
        ...
        """
        LOGGER.info('Started Nuvo Simplese Controller NodeServer')
    ...
    def discover(self, *args, **kwargs):
        ...
        for x in range(1,5):
            ...
            self.addNode(SimpleseNode(self, self.address, address, name, gc))
    ...
    def check_params(self):
        ...
        if 'host' in self.polyConfig['customParams']:
            ...
            self.host = '192.168.1.70' # default globalcache
...
class SimpleseNode(polyinterface.Node):
    ...
    def __init__(self, controller, primary, address, name, client):
        ...
        self.name = name
        self.client = client
        super(SimpleseNode, self).__init__(controller, primary, address, name)
    ...
    def parse_status(self, response):
        try:
            ...
            # Match Groups: 0-All, 1- PWR ON/OFF, 2- SRC [1-4],GRP [0-4],VOL int, P ON/OFF
    ...
    def _source(self, *args):
        source = args[0]['value']
        if source and int(source) in range(1,5):
...
nuvo_factory.register_nodes('SIMPLESE', SimpleseController, SimpleseNode)
